...
# Fir variant of requirements installation.
# Run: bash hpc/fir_requirements_installation.sh  (from project root)
...
echo "=== FACE-VERIFICATION ENVIRONMENT INSTALLATION (Fir) ==="

module purge
module load StdEnv/2023 gcc/12.3 cuda/12.6 cudnn python/3.11 opencv/4.8.1
echo "Loaded modules:"; module list

PERSISTENT_DIR=/scratch/enazari/fir-face-verification-env
...
BUILD_ENV=$SLURM_TMPDIR/fir-face-verification-env
